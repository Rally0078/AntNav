...
NEED_RL=false   #Set to true if RL training is needed
...
if [ "$NEED_RL" = true ]; then
    echo "Installing Reinforcement Learning training packages"
    ...
    echo "Reinforcement Learning training packages not added"
fi
